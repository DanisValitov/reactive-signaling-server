...
public class ReactiveWebSocketEchoHandler implements WebSocketHandler {
	...
	public Mono<Void> handle(WebSocketSession webSocketSession) {
		...
		log.info("handShakeInfo : {}", webSocketSession.getHandshakeInfo());
	...
	private static class EchoSubPublisher implements Publisher<WebSocketMessage>, Subscriber<WebSocketMessage>,
			Subscription {
